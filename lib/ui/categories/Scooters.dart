import 'package:beepy_app/ui/categories/info/Scooter_info.dart';
            ...
            body: Builder(builder: (context) {
              if (state is BeepLoadingState) {
                ...
                return ListView.builder(
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ScooterInfoPage(
                                    info: state.data.scooters[index])));
                      },
                      child: Stack(
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:
                                        Color(state.data.scooters[index].color),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        state.data.scooters[index].title,
                                      ...
                                      Text(
                                        "${state.data.scooters[index].price}/day",
                                        style: const TextStyle(
                                            color: Colors.white),
                                      ),
                                      const SizedBox(
                  ...
                  itemCount: state.data.scooters.length,
                );
              } else {
