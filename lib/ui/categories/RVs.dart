import 'package:beepy_app/ui/categories/info/RVs_info.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

import '../../cubit/beep_state.dart';

class RVs extends StatelessWidget {
  const RVs({super.key});
              ...
              if (state is BeepLoadingState) {
                ...
                return ListView.builder(
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> RVsInfoPage(info: state.data.rVs[index])));
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:
                                        Color(state.data.rVs[index].color),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${state.data.rVs[index].price}/day",
                                        style: const TextStyle(
                                            color: Colors.white),
                                      ),
                                      const SizedBox(
                  ...
                  itemCount: state.data.rVs.length,
                );
              } else {
