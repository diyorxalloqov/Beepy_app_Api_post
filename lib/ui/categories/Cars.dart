import 'package:beepy_app/ui/categories/info/Cars_info.dart';
              ...
              if (state is BeepLoadingState) {
                ...
                return ListView.builder(
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> CarsInfoPage(info: state.data.cars[index])));
                      },
                      child: Stack(
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:
                                        Color(state.data.cars[index].color),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${state.data.cars[index].price}/day",
                                        style: const TextStyle(
                                            color: Colors.white),
                                      ),
                                      const SizedBox(
