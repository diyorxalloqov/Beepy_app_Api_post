import 'package:beepy_app/ui/categories/info/BigCars_info.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

import '../../cubit/beep_state.dart';

class BigCars extends StatelessWidget {
  const BigCars({super.key});
              ...
              if (state is BeepLoadingState) {
                ...
                return ListView.builder(
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> BigCarsInfoPage(info: state.data.bigCars[index])));
                      },
                      child: Stack(
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:
                                        Color(state.data.bigCars[index].color),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        state.data.bigCars[index].title,
                                      ...
                                      Text(
                                        "${state.data.bigCars[index].price}/day",
                                        style: const TextStyle(
                                            color: Colors.white),
                                      ),
                                      const SizedBox(
                  ...
                  itemCount: state.data.bigCars.length,
                );
              } else {
